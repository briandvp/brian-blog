...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    // Suscripción
    'subscribe.emailPlaceholder': 'Tu correo electrónico',
    'subscribe.namePlaceholder': 'Tu nombre (opcional)',
    'subscribe.button': 'Suscribirse',
    'subscribe.submitting': 'Suscribiendo...',
    'subscribe.success': '¡Suscripción exitosa! Te hemos agregado a nuestra lista.',
    'subscribe.error': 'Error al suscribirse. Por favor, intenta de nuevo.',
    'subscribe.emailRequired': 'Por favor, ingresa tu correo electrónico',
    'subscribe.page.title': 'Únete a nuestra comunidad',
    'subscribe.page.subtitle': 'Recibe las últimas publicaciones sobre estoicismo, desarrollo personal y reflexiones directamente en tu correo',
    'subscribe.page.formTitle': 'Suscríbete ahora',
    'subscribe.page.privacy': 'Al suscribirte, aceptas recibir emails con nuestras publicaciones. Puedes cancelar tu suscripción en cualquier momento.',
    'subscribe.page.benefitsTitle': '¿Qué recibirás?',
    'subscribe.page.benefit1.title': 'Nuevas publicaciones',
    'subscribe.page.benefit1.description': 'Recibe notificaciones cuando publiquemos nuevos artículos sobre estoicismo y desarrollo personal',
    'subscribe.page.benefit2.title': 'Contenido exclusivo',
    'subscribe.page.benefit2.description': 'Acceso a contenido especial y reflexiones profundas sobre la filosofía estoica',
    'subscribe.page.benefit3.title': 'Sin spam',
    'subscribe.page.benefit3.description': 'Solo te enviaremos contenido valioso y relevante, respetando tu privacidad',
    'subscribe.page.benefit4.title': 'Cancela cuando quieras',
    'subscribe.page.benefit4.description': 'Puedes darte de baja en cualquier momento con un solo clic',
    'subscribe.page.stats.subscribers': '+1000',
    'subscribe.page.stats.subscribersLabel': 'Suscriptores',
    'subscribe.page.stats.content': '50+',
    'subscribe.page.stats.contentLabel': 'Artículos',
    'subscribe.page.faqTitle': 'Preguntas frecuentes',
    'subscribe.page.faq1.question': '¿Con qué frecuencia recibiré emails?',
  ...
  en: {
    ...
    'subscribe.namePlaceholder': 'Your name (optional)',
    'subscribe.button': 'Subscribe',
    'subscribe.submitting': 'Subscribing...',
    'subscribe.success': 'Subscription successful! We\'ve added you to our list.',
    'subscribe.error': 'Error subscribing. Please try again.',
    'subscribe.emailRequired': 'Please enter your email address',
    'subscribe.page.title': 'Join our community',
    'subscribe.page.subtitle': 'Receive the latest posts about stoicism, personal development and reflections directly in your inbox',
    'subscribe.page.formTitle': 'Subscribe now',
    'subscribe.page.privacy': 'By subscribing, you agree to receive emails with our publications. You can cancel your subscription at any time.',
    'subscribe.page.benefitsTitle': 'What will you receive?',
    'subscribe.page.benefit1.title': 'New publications',
    'subscribe.page.benefit1.description': 'Get notified when we publish new articles about stoicism and personal development',
    'subscribe.page.benefit2.title': 'Exclusive content',
    'subscribe.page.benefit2.description': 'Access to special content and deep reflections on stoic philosophy',
    'subscribe.page.benefit3.title': 'No spam',
    'subscribe.page.benefit3.description': 'We\'ll only send you valuable and relevant content, respecting your privacy',
    'subscribe.page.benefit4.title': 'Cancel anytime',
    'subscribe.page.benefit4.description': 'You can unsubscribe at any time with a single click',
    'subscribe.page.stats.subscribers': '+1000',
    'subscribe.page.stats.subscribersLabel': 'Subscribers',
    'subscribe.page.stats.content': '50+',
    'subscribe.page.stats.contentLabel': 'Articles',
    'subscribe.page.faqTitle': 'Frequently asked questions',
    'subscribe.page.faq1.question': 'How often will I receive emails?',
